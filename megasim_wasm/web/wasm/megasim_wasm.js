/* @ts-self-types="./megasim_wasm.d.ts" */
...
export class Simulator {
    ...
    constructor(source) {
        ...
        const ret = wasm.simulator_new(ptr0, len0);
    ...
    program_str() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.simulator_program_str(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
     ...
     */
    state() {
        const ret = wasm.simulator_state(this.__wbg_ptr);
        return ret;
    }
    /**
     * @returns {boolean}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('megasim_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
